...
describe('Task', () => {
  ...
  it("should have a duration", () => {
    expect(task.getDurationInSeconds()).toEqual(endDateTime.getTime() - startDateTime.getTime() / 1000);
  });
  ...
  it("should update the start date and have the correct duration", () => {
    ...
    expect(task.getDurationInSeconds()).toEqual(task.endDate.getTime() - newStartDateTime.getTime() / 1000);
  });
  ...
  it("should update the end date and have the correct duration", () => {
    ...
    expect(task.getDurationInSeconds()).toEqual(newEndDateTime.getTime() - task.startDate.getTime() / 1000);
  });
  ...
  it("should update the start and end date and have the correct duration", () => {
    ...
    expect(task.startDate).toEqual(newStartDateTime);
    expect(task.endDate).toEqual(newEndDateTime);
    expect(task.getDurationInSeconds()).toEqual(newEndDateTime.getTime() - newStartDateTime.getTime() / 1000);
  });
